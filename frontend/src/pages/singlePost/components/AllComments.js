...
import { LikeComment } from '../../../functions/likingPost';
...
export default function Post({post,user, LogedInUserLikesPosts,finalresultStyle}) {
 ...
 const subcommentandallcomments = ()=> {
  ChangePost(post)
  // GettingComments();
  ...
  return (
    <>  
      ...
      <div 
              id={
                finalresultStyle === true ? "postBoxforcomments": "postBox" 
              }
      >
       ...
       <Link to={`/profile/${post?.user?.username}`} >  <img src={post?.user?.picture} alt="" /></Link>   
       {
        ...
        <div id="mainpost" >
          ...
          <div id="LikeCommentShareReport">
            ...
            <div  id='ClickonPost'  >
            <div className='reactions'>
              <div onClick={subcommentandallcomments}  className='buttonsBackground' >
